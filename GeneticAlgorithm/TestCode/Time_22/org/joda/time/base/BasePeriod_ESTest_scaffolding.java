...
public class BasePeriod_ESTest_scaffolding {
  ...
  public static void setSystemProperties() {
    ...
    java.lang.System.setProperty("user.dir", "/tmp/evosuite-ga-Time_22-r2.h7WhgG"); 
    java.lang.System.setProperty("java.io.tmpdir", "/tmp"); 
  }

  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BasePeriod_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.joda.time.format.DateTimeParser", false, BasePeriod_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.DateTimePrinter", false, BasePeriod_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.PeriodParser", false, BasePeriod_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.joda.time.format.PeriodPrinter", false, BasePeriod_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BasePeriod_ESTest_scaffolding.class.getClassLoader()); 
