...
public class ListPopulation_ESTest extends ListPopulation_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(288, 1.0);
  ...
  public void test02()  throws Throwable  {
      ...
      List<Chromosome> list0 = List.of(chromosome0, chromosome0, chromosome0, chromosome0, chromosome0);
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(list0, 13, 0);
      // Undeclared exception!
      try { 
        elitisticListPopulation0.setPopulationLimit(1);
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // 1 is smaller than the minimum (5)
         //
         verifyException("org.apache.commons.math3.genetics.ListPopulation", e);
      }
  }
  ...
  public void test03()  throws Throwable  {
      ...
      doReturn(0, 0, 0, 0, 2756).when(chromosome0).compareTo(any(org.apache.commons.math3.genetics.Chromosome.class));
      List<Chromosome> list0 = List.of(chromosome0, chromosome0, chromosome0, chromosome0, chromosome0);
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(list0, 13, 0);
      elitisticListPopulation0.getFittestChromosome();
      assertEquals(13, elitisticListPopulation0.getPopulationLimit());
  }
  ...
  public void test05()  throws Throwable  {
      Chromosome chromosome0 = mock(Chromosome.class, new ViolatedAssumptionAnswer());
      List<Chromosome> list0 = List.of(chromosome0, chromosome0, chromosome0, chromosome0, chromosome0);
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(list0, 5, 0);
      // Undeclared exception!
      try { 
  ...
  public void test07()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = new ElitisticListPopulation(2, 0.9);
      // Undeclared exception!
      try { 
  ...
  public void test08()  throws Throwable  {
      ...
      try {
        elitisticListPopulation0 = new ElitisticListPopulation(list0, 2, (-12));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((-2143), (-2143));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      ElitisticListPopulation elitisticListPopulation0 = null;
      try {
        elitisticListPopulation0 = new ElitisticListPopulation((List<Chromosome>) null, 31, 31);
        fail("Expecting exception: IllegalArgumentException");
