...
public class ISO8601Utils_ESTest extends ISO8601Utils_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      try { 
        ISO8601Utils.parse("7O]2t6", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Failed to parse date [\"7O]2t6']: Invalid number: 7O]2
         //
  ...
  public void test01()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(0);
      try { 
        ISO8601Utils.parse("\"3@a_$_p&A+wCk", parsePosition0);
        fail("Expecting exception: ParseException");
      
      } catch(ParseException e) {
         //
         // Failed to parse date [\"\"3@a_$_p&A+wCk']: Invalid number: \"3@a
         //
         verifyException("com.google.gson.internal.bind.util.ISO8601Utils", e);
      }
  }
  ...
  public void test05()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(0);
      Date date0 = ISO8601Utils.parse("2106-09-11T05:00:00+00:00", parsePosition0);
  ...
  public void test07()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(0);
      Date date0 = ISO8601Utils.parse("1905-04-02T14:59:59-00:00", parsePosition0);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }
  ...
  public void test08()  throws Throwable  {
      ParsePosition parsePosition0 = new ParsePosition(57);
      parsePosition0.setIndex(0);
      Date date0 = ISO8601Utils.parse("2014-02-15T14:21:21.320+18:00", parsePosition0);
      assertEquals("Fri Feb 14 20:21:21 GMT 2014", date0.toString());
  }

  @Test(timeout = 4000)
  public void test09()  throws Throwable  {
      MockDate mockDate0 = new MockDate(0, 63, 0, 63, 0);
      SimpleTimeZone simpleTimeZone0 = new SimpleTimeZone((-1), "@");
      String string0 = ISO8601Utils.format((Date) mockDate0, false, (TimeZone) simpleTimeZone0);
      assertEquals("1905-04-02T14:59:59-00:00", string0);
  }
