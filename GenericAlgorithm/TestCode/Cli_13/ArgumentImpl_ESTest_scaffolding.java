...
public class ArgumentImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.commons.cli2.option.ArgumentImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ArgumentImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, ArgumentImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.ListIterator", false, ArgumentImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.commons.cli2.DisplaySetting", false, ArgumentImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ArgumentImpl_ESTest_scaffolding.class.getClassLoader()); 
